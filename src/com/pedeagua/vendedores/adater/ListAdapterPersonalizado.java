package com.pedeagua.vendedores.adater;
...
public class ListAdapterPersonalizado extends BaseAdapter {
    ...
    private List<Vendedor> movieItems;
    ImageLoader imageLoader = AppController.getInstance().getImageLoader();
 
    public ListAdapterPersonalizado(Activity activity, List<Vendedor> movieItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // TextView genre = (TextView) convertView.findViewById(R.id.genre);
        ...
        Vendedor m = movieItems.get(position);
